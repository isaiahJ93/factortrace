...
def add_materiality_assessment(parent: ET.Element, data: Dict[str, Any]) -> None:
    ...
    if mat_data:
        ...
        # Fixed: Use proper ESRS materiality element
    create_enhanced_xbrl_tag(
        p_impact,
        'nonNumeric',
...
def add_governance_section(parent: ET.Element, data: Dict[str, Any]) -> None:
    ...
    # Fixed: Board oversight as plain text (no standard ESRS element)
    ...
    if gov_data.get('board_meetings_climate'):
        ...
        # Fixed: Board meetings as plain text
    ...
    # Fixed: Management responsibility as plain text
    ...
    if gov_data.get('climate_expertise'):
        ...
        # Fixed: Removed empty XBRL name

        span = ET.SubElement(parent, 'span')

        span.text = str('nonNumeric') if 'nonNumeric' is not None else ''
    # Incentives
...
def add_transition_plan_section(parent: ET.Element, data: Dict[str, Any]) -> None:
    ...
    span.text = "Yes" if tp_data.get("adopted", False) else "No"
    if tp_data.get('adopted'):
        ...
        span = ET.SubElement(parent, 'span')
        span.text = str(tp_data.get("net_zero_target_year", 2050)) if tp_data.get("net_zero_target_year", 2050) is not None else ""
        ...
        if tp_data.get('financial_planning'):
            ...
            if tp_data['financial_planning'].get('capex_allocated'):
                ...
                span.text = str('nonFraction') if 'nonFraction' is not None else ''
...
def add_climate_policy_section_enhanced(parent: ET.Element, data: Dict[str, Any]) -> None:
    ...
    span = ET.SubElement(parent, 'span')
    span.text = "Yes" if policy_data.get("has_climate_policy", False) else "No"
    ...
    if data.get('scope3_detailed'):
        ...
        for i in range(1, 16):
            ...
            if not cat_data.get('excluded', False):
                ...
                span.text = str(data.get('emissions_tco2e', 0)) if data.get('emissions_tco2e', 0) is not None else '',
                    unit_ref='u-tCO2e',
                    decimals='0'
            else:
...
def add_removals_section(parent: ET.Element, data: Dict[str, Any]) -> None:
    ...
    if credits_data.get('used'):
        ...
        span.text = str(data.get('total_amount', 0)) if data.get('total_amount', 0) is not None else '',
            unit_ref='u-tCO2e',
            decimals='0'
...
def add_carbon_pricing_section_enhanced(parent: ET.Element, data: Dict[str, Any]) -> None:
    ...
    span.text = str(data.get('implemented', False)) if data.get('implemented', False) is not None else '' else 'No',
        xml_lang='en'
...
def add_e1_9_financial_effects_section(parent: ET.Element, data: Dict[str, Any]) -> None:
    ...
    span.text = str(data.get('financial_effects', {})) if data.get('financial_effects', {}) is not None else ''.get('physical_risks', {}).get('total_impact', 0)),
        unit_ref='u-EUR',
        decimals='0'
    ...
    span.text = str(data.get('financial_effects', {})) if data.get('financial_effects', {}) is not None else ''.get('transition_opportunities', {}).get('total_impact', 0)),
        unit_ref='u-EUR',
        decimals='0'
...
def add_value_chain_section(parent: ET.Element, data: Dict[str, Any]) -> None:
    ...
    if data.get('value_chain', {}).get('upstream'):
        ...
        span.text = str(data.get('suppliers_with_targets_percent', 0)) if data.get('suppliers_with_targets_percent', 0) is not None else '',
            unit_ref='u-percent',
            decimals='1',
...
def add_methodology_section(parent: ET.Element, data: Dict[str, Any]) -> None:
    ...
    span.text = str(data.get('methodology', {})) if data.get('methodology', {}) is not None else ''.get('ghg_standard', 'GHG Protocol Corporate Standard'),
        xml_lang='en'
    ...
    span.text = str(data.get('methodology', {})) if data.get('methodology', {}) is not None else ''.get('consolidation_approach', 'Operational control'),
        xml_lang='en'
    # Emission factors
    ...
    span.text = str(data.get('data_quality_score', 0)) if data.get('data_quality_score', 0) is not None else '',
        decimals='0'
    p_quality.tail = '/100'
    # Uncertainty assessment
...
def add_assurance_section(parent: ET.Element, data: Dict[str, Any]) -> None:
    ...
    if assurance_data:
        ...
        span.text = str(data.get('level', 'Limited assurance')) if data.get('level', 'Limited assurance') is not None else '',
            xml_lang='en'
        ...
        span.text = str(data.get('provider', 'TBD')) if data.get('provider', 'TBD') is not None else '',
            xml_lang='en'
        ...
        span.text = str(data.get('standard', 'ISAE 3410')) if data.get('standard', 'ISAE 3410') is not None else '',
            xml_lang='en'
        # Scope of assurance
...
def create_enhanced_ixbrl_structure(data: Dict[str, Any], doc_id: str, timestamp: datetime) -> ET.Element:
    ...
    # DUPLICATE HTML REMOVED - this should be merged with main generation
