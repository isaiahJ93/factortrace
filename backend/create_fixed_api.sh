#!/bin/bash
# create_fixed_api.sh - Create the fixed API quickly

cat > ghg_monte_carlo_fixed_simple.py << 'EOAPI'
...
echo "✅ Created ghg_monte_carlo_fixed_simple.py"
echo "🚀 To run: python ghg_monte_carlo_fixed_simple.py"