...
"
        ...
        try:
            ...
            if total == 0:
# 🔧 REVIEW: possible unclosed bracket ->                 feedback.append(DataQualityFeedback()
...
"
        ...
        if critical_count >= 3:
# 🔧 REVIEW: possible unclosed bracket ->             all_feedback.append(DataQualityFeedback()
...
# 🔧 REVIEW: possible unclosed bracket ->                 futures = {}
...
# 🔧 REVIEW: possible unclosed bracket ->                         self.results.append(ProcessingResult()
...
# 🔧 REVIEW: possible unclosed bracket ->             return ProcessingResult()
    ...
    def _construct_voucher_data() -> Dict[str, Any]:
        "
"
# 🔧 REVIEW: possible unclosed bracket ->         voucher_data = {}
            'lei': row['lei']'
...
# 🔧 REVIEW: possible unclosed bracket ->         voucher_data['ai_data_quality_summary']'
    ...
    def _enhance_narrative_with_ai() -> str:
        "
"
# 🔧 REVIEW: possible unclosed bracket ->         base_narratives = {}
...
"
        ...
        with open(summary_path, 'w', newline=', encoding='utf-8')'
            if self.results:
...
"
        ...
        zip_path = self.output_base_dir.parent /
