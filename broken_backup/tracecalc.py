...
class TraceCalc:
    def __init__(self, factor_loader: "EmissionFactorLoader")"
        self.factor_loader = factor_loader

    def calculate(self, items: List[Dict[str, Any], method: str = "auto")"
...
# 🔧 REVIEW: possible unclosed bracket ->             results.append()

# 🔧 REVIEW: possible unclosed bracket ->                 ItemResult()
...
# 🔧 REVIEW: possible unclosed bracket ->         return CalcResult()
