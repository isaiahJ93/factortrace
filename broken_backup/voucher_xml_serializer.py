...
# 🔧 REVIEW: possible unclosed bracket -> FIELD_ORDER: List[str] = []
...
# 🔧 REVIEW: possible unclosed bracket ->     xml_bytes = tostring()
...
if __name__ == "__main__"
    ...
    payload = json.loads().read_text(encoding="utf-8")"
    xml_out = serialize_voucher(payload)
    print(xml_out)

# 🔧 REVIEW: possible unclosed bracket ->     xsd_file = ()
